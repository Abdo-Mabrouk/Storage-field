            ...
            <div className="bg-black" >
                ...
                <div className="container mx-auto  grid grid-cols-6 justify-between gap-4 lg:gap-0 items-center">
                    <div className="lg:col-span-2 md:col-span-6 col-span-6 space-y-5">
                        ...
                        <Image src={logo} className=" max-w-[300px] lg:w-full h-auto"/>
                        <div className="text-white space-y-10">
                            ...
                            <ul className="flex justify-start items-center gap-2 md:gap-[18px] ">
                                <li><a href="#" className=" size-[50px] md:size-[56px] text-white border-2 border-white rounded-full flex justify-center items-center hover:bg-orange-500 hover:border-orange-500 hover:transition-colors duration-400"><FontAwesomeIcon icon={faSnapchat} className="  text-lg md:text-[24px]" /></a></li>
                                <li><a href="#" className=" size-[50px] md:size-[56px] text-white border-2 border-white rounded-full flex justify-center items-center hover:bg-orange-500 hover:border-orange-500 hover:transition-colors duration-400"><FontAwesomeIcon icon={faFacebook} className=" text-lg md:text-[24px]"/></a></li>
                                <li><a href="#" className=" size-[50px] md:size-[56px] text-white border-2 border-white rounded-full flex justify-center items-center hover:bg-orange-500 hover:border-orange-500 hover:transition-colors duration-400"><FontAwesomeIcon icon={faLinkedinIn} className="   text-lg md:text-[24px]"/></a></li>
                                <li><a href="#" className=" size-[50px] md:size-[56px] text-white border-2 border-white rounded-full flex justify-center items-center hover:bg-orange-500 hover:border-orange-500 hover:transition-colors duration-400"><FontAwesomeIcon icon={faXTwitter} className=" text-lg md:text-[24px]"/></a></li>
                                <li><a href="#" className=" size-[50px] md:size-[56px] text-white border-2 border-white rounded-full flex justify-center items-center hover:bg-orange-500 hover:border-orange-500 hover:transition-colors duration-400"><FontAwesomeIcon icon={faYoutube} className="   text-lg md:text-[24px]"/></a></li>
                            </ul>
                        </div>
                        </div>
                    </div>
                    ...
                    <div className="lg:col-span-2 md:col-span-3 col-span-6 space-y-5 text-2xl md:text-start text-white">
                        <p className=" text-[24px] mb-[48px] font-[500]  text-center lg:text-start ">طرق التواصل</p>
