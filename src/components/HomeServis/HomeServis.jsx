        ...
        <div className="grid grid-cols-12 gap-[24px]">
          <div className="CardServis space-y-5 group bg-repeat hover:border-orange-500 col-span-12 md:col-span-6 lg:col-span-4 p-[24px] border-2 border-gray-200 rounded-3xl">
            ...
            <p className="text-[16px] text-[#666]">
              نوفر لك خدمات التخزين بحسب المساحات التي ترغب بها (تخزين الارفف/
              تخزين الطبليات)
            </p>
            <Link href="/StorageforOthers">
              {" "}
              <button className="btn group-hover:bg-orange-500 group-hover:border-orange-500 w-full border-[#CCC] hover:border-orange-500">
                {" "}
                عرض المزيد{" "}
              </button>
            </Link>
          ...
          <div className="CardServis space-y-5 group bg-white hover:border-orange-500 col-span-12 md:col-span-6 lg:col-span-4 p-[24px] border-2 border-gray-200 rounded-3xl">
            ...
            <p className="text-[16px] text-[#666]">
              خدمات متكاملة لخدمة المتاجر الاكترونية ادارة الطلبات - تجهيز طلبات
              - تغليف الطلبات - الشحن
            </p>
            <Link href="/StorageforOthers">
              {" "}
          ...
          <div className="CardServis space-y-5 group bg-white hover:border-orange-500 col-span-12 md:col-span-6 lg:col-span-4 p-[24px] border-2 border-gray-200 rounded-3xl">
            ...
            <p className="text-[16px] text-[#666]">
              نوفر خدمات التخزين الذاتي للشركات بمستوى عالٍ من الأمان، ونمنحها
              التحكم الكامل في ممتلكاتها.
            </p>
            <Link href="/StorageforOthers">
            <button className="btn group-hover:bg-orange-500 group-hover:border-orange-500 w-full border-[#CCC] hover:border-orange-500">
              {" "}
          ...
          <div className="CardServis space-y-5 group bg-white hover:border-orange-500 col-span-12 md:col-span-6 lg:col-span-4 p-[24px] border-2 border-gray-200 rounded-3xl">
            ...
            <p className="text-[16px] text-[#666]">
              نوفر مساحات مكتبية داخل مستودعاتنا للاستخدام من قبل الشركات.
          ...
          <div className="CardServis space-y-5 group bg-white hover:border-orange-500 col-span-12 md:col-span-6 lg:col-span-4 p-[24px] border-2 border-gray-200 rounded-3xl">
            ...
            <p className="text-[16px] text-[#666]">
              نوفر خدمة ترخيص المنشأت الطبية والتجميلية والغذائية و ترخيص
              المستودعات .
            </p>
            <Link href="/StorageforOthers">
            <button className="btn group-hover:bg-orange-500 group-hover:border-orange-500 w-full border-[#CCC] hover:border-orange-500">
          ...
          <div className="CardServis space-y-5 group bg-white hover:border-orange-500 col-span-12 md:col-span-6 lg:col-span-4 p-[24px] border-2 border-gray-200 rounded-3xl">
            ...
            <p className="text-[16px] text-[#666]">
              نعمل مع عملائنا من اجل فهم الاحتياجات والرغبات الخاصة بفريق عملهم
              وزبائنهم.
            </p>
            <Link href="/StorageforOthers">
            <button className="btn group-hover:bg-orange-500 group-hover:border-orange-500 w-full border-[#CCC] hover:border-orange-500">
