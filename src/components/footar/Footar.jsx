    ...
    return (
        <>
            <div className="bg-black/50" >
                ...
                <div className="container mx-auto grid grid-cols-6 justify-between gap-4 lg:gap-0 items-center">
                    <div className="lg:col-span-2 md:col-span-6 col-span-6 space-y-5">
                        <div className="flex flex-col justify-center items-start gap-10">
                        <Image src={logo} className=" maxw-[300px] md:w-full h-auto"/>
                        <div className="text-black space-y-10">
                            ...
                            <ul className="flex justify-start items-center gap-2 md:gap-[18px] ">
                                <li><a href="#" className=" size-[50px] md:size-[56px] text-black border-2 border-btext-black rounded-full flex justify-center items-center hover:bg-orange-500 hover:border-orange-500 hover:transition-colors duration-400"><FontAwesomeIcon icon={faSnapchat} className="  text-lg md:text-[24px]" /></a></li>
                                <li><a href="#" className=" size-[50px] md:size-[56px] text-black border-2 border-btext-black rounded-full flex justify-center items-center hover:bg-orange-500 hover:border-orange-500 hover:transition-colors duration-400"><FontAwesomeIcon icon={faFacebook} className=" text-lg md:text-[24px]"/></a></li>
                                <li><a href="#" className=" size-[50px] md:size-[56px] text-black border-2 border-btext-black rounded-full flex justify-center items-center hover:bg-orange-500 hover:border-orange-500 hover:transition-colors duration-400"><FontAwesomeIcon icon={faLinkedinIn} className="   text-lg md:text-[24px]"/></a></li>
                                <li><a href="#" className=" size-[50px] md:size-[56px] text-black border-2 border-btext-black rounded-full flex justify-center items-center hover:bg-orange-500 hover:border-orange-500 hover:transition-colors duration-400"><FontAwesomeIcon icon={faXTwitter} className=" text-lg md:text-[24px]"/></a></li>
                                <li><a href="#" className=" size-[50px] md:size-[56px] text-black border-2 border-btext-black rounded-full flex justify-center items-center hover:bg-orange-500 hover:border-orange-500 hover:transition-colors duration-400"><FontAwesomeIcon icon={faYoutube} className="   text-lg md:text-[24px]"/></a></li>
                            </ul>
                        </div>
                        </div>
                    </div>
                    <div className="lg:col-span-2 md:col-span-3 col-span-6 space-y-5 lg:px-20">
                        <p className="text-black text-center lg:text-star text-[24px] mb-[48px] font-[500] ">روابط مختصره</p>
                    ...
                    <div className="lg:col-span-2 md:col-span-3 col-span-6 space-y-5 text-2xl md:text-start text-black">
                        <p className=" text-[24px] mb-[48px] font-[500]  text-center lg:text-star">طرق التواصل</p>
